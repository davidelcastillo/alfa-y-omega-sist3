...
export default function ComprobanteStatsCards({ total, conSaldo, cancelados, montoTotal }: Props) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
      <Card label="Total Comprobantes de Proveedores" value={total} gradient="from-pink-500 to-pink-300">
        <ClipboardList className="w-6 h-6 text-white" />
      </Card>
      <Card label="Comprobantes con Saldo" value={conSaldo} valueClass="text-green-600" gradient="from-green-400 to-green-600">
