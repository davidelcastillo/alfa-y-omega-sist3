...
{items.map((it) => (
<Link key={it.label} href={it.href} className={`menu-item flex items-center space-x-4 p-4 rounded-xl ${it.active ? 'text-white bg-gradient-to-r from-primary-pink to-primary-blue' : 'text-gray-700 hover:text-white'}`}>
{it.icon}
